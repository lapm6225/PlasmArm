...
#define TOOL_PIN 25 // GPIO for tool ON/OFF relay

// Z-axis (servo for pen up/down, or stepper for plasma torch height)
#define Z_AXIS_PIN 26    // GPIO for Z-axis servo
#define Z_AXIS_MIN 0.0f  // Z minimum position (mm)
#define Z_AXIS_MAX 50.0f // Z maximum position (mm)
